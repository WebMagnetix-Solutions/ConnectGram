...
const EditProfile = ({ setMyData, myData, setEdit, isEdit }) => {
    ...
    return (
        <div className={`w-1/2 flex absolute z-50 justify-center h-screen duration-500 transition-all ${isEdit ? `bg-black bg-opacity-40` : `bg-none bg-opacity-0 pointer-events-none`}`}>
